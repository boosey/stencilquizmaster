...
import { f as rIC, d as assert, g as debounce } from './chunk-f2ab991b.js';
import { a as isPlatform } from './chunk-523a9283.js';
import { e as createOverlay, f as dismissOverlay, g as getOverlay } from './chunk-1004ea03.js';
...
class AppCommands {
    ...
    static get is() { return "app-commands"; }
    ...
    static get listeners() { return [{
            ...
            "method": "addGameRequestedHandler"
        }, {
            "name": "userUpdated",
            "method": "userUpdatedHandler"
        }]; }
    ...
    render() {
        return (h("ion-app", null,
            h("ion-router", { useHash: false },
                ...
                h("ion-route", { url: "/addgame", component: "app-add-game" }),
                h("ion-route", { url: "/editgame/:gameId", component: "app-edit-game" }),
                h("ion-route", { url: "/playgame/:gameId", component: "app-play-game" })),
            h("app-commands", null,
                h("ion-nav", null))));
    }
...
export { AppCommands, AppRoot, App as IonApp, Nav as IonNav, Route as IonRoute, Router as IonRouter, ToastController as IonToastController };
