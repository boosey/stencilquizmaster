...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "App","app",0,"app.core.js","es5-build-disabled.js","hydrated","app-add-game,app-commands,app-edit-game,app-home,app-mainmenu,app-play-game,app-profile,app-root,ion-animation-controller,ion-app,ion-back-button,ion-backdrop,ion-button,ion-buttons,ion-card,ion-card-content,ion-card-header,ion-card-title,ion-col,ion-content,ion-grid,ion-header,ion-icon,ion-input,ion-item,ion-label,ion-list,ion-loading,ion-loading-controller,ion-menu,ion-menu-controller,ion-menu-toggle,ion-nav,ion-ripple-effect,ion-route,ion-router,ion-row,ion-spinner,ion-title,ion-toast,ion-toast-controller,ion-toggle,ion-toolbar,stencil-route-link",HTMLElement.prototype);